GreyWolf = {
	...
	Properties = {
		...
		object_Model = "objects/characters/animals/greywolf/greywolf.cdf",
		Size = 1,
		...
		{
			Health = 90, 
			fileBodyDamage = "Libs/BodyDamage/BodyDamage_GreyWolf.xml",  -- Not used by animal system - this is read in directly by Body Damage system
			fileBodyDamageParts = "Libs/BodyDamage/BodyParts_GreyWolf.xml",  -- Not used by animal system - this is read in directly by Body Damage system
		},
...
function GreyWolf:OnSave(tbl)
end

function GreyWolf:OnLoad(tbl)
end

function GreyWolf:OnShutDown()
end
