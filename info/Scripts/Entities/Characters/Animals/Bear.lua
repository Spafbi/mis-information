Bear = {
	...
	Properties =
	{
		object_Model = "objects/characters/animals/bear/bear.cdf",
		Size = 1,
		...
		esLootItemCategory = "RandomBearLoot", -- loot category must exist in ItemSpawnerManager.lua, empty/missing means no loot
		...
		Damage =
		{
			...
			fileBodyDamage = "Libs/BodyDamage/BodyDamage_Bear.xml",  -- Not used by animal system - this is read in directly by Body Damage system
			fileBodyDamageParts = "Libs/BodyDamage/BodyParts_Bear.xml",  -- Not used by animal
		},
		...
		Readabilities =
		{
			...
			Mannequin =
			{
				...
				Sounds =
				{
					Hurt = "Play_bear_death",
					Death = "Play_bear_death",
				},
			},
		},
		...
		Bones =
		{
			...
			BONE_FOOT_R = "bear_r_wrist_jnt",
			BONE_FOOT_L = "bear_l_wrist_jnt",
			BONE_FOOT_R2 = "bear_r_foot_jnt", -- back right
			BONE_FOOT_L2 = "bear_l_foot_jnt", -- back left
		},
...
function Bear:OnSave(tbl)
end

function Bear:OnLoad(tbl)
end

function Bear:OnShutDown()
end
