Spiker = {
	...
	Properties = {
		...
		object_Model = "objects/characters/bandits/spiker/spiker.cdf",
		Size = 1,
		...
		{
			bKytheraEnabled = 1,
			esKytheraProfile = "Spiker", -- valid profiles defined in Scripts/Kythera/Profiles.xml
		},
...
function Spiker:OnSave(tbl)
end

function Spiker:OnLoad(tbl)
end

function Spiker:OnShutDown()
end
