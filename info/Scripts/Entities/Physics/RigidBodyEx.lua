...
-- EI: Override params, see: http://docs.cryengine.com/display/SDKDOC4/EntityUtils+Lua#EntityUtilsLua-MakeDerivedEntity
-- MakeDerivedEntity( RigidBodyEx,BasicEntity )
MakeDerivedEntityOverride( RigidBodyEx,BasicEntity )
