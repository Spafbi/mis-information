...
--------------------------------------------------------------------------
function VehicleBase:IsActionable(user)
	--Log("[ VehicleBase ] IsActionable");
...
function VehicleBase:GetActions(user)
	--Log("[ VehicleBase ] GetActions");
...
function VehicleBase:PerformAction(user, action)
	--Log("[ VehicleBase ] PerformAction: action="..action);
