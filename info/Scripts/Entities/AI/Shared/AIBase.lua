...
AIBase =
{
	...
	physicsParams =
	{
		Living =
		{
			-- Kythera: Set these quite a few degrees higher than navmesh AgentMaxSlope parameter so that
			-- AI can better cope with unusually bumpy areas such as rocky shorelines where excessively
			-- steep meshes occasionally get through due to voxelisation resolution limitations
			max_climb_angle = 75.0,
			min_slide_angle = 70.0,
			min_fall_angle = 75.0,
		},
	},
