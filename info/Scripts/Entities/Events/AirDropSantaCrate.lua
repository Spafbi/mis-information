CreateItemTable("AirDropSantaBag");

-- Called when the crate is initially dropped
--function AirDropSantaBag:OnDropped()
	--Log("AirDropSantaBag - OnDropped")
--end
...
--function AirDropSantaBag:OnLanding()
	--Log("AirDropSantaBag - OnLanding")
--end
...
--function AirDropSantaBag:OnLanded()
	--Log("AirDropSantaBag - OnLanded")
--end