...
function PipeManager:ReloadScripts()
	...
	--Script.ReloadScript("Scripts/AI/GoalPipes/PipeManagerGeneric.lua");
	...
	Script.ReloadScript("Scripts/AI/GoalPipes/PipeManagerMutant.lua");
...
function PipeManager:CreateGoalPipes()
	...
	-- Specific (Lua)
	--PipeManager:OnInitGeneric();
	PipeManager:OnInitMutant();
	...
	AI.LoadGoalPipes("Scripts/AI/GoalPipes/GoalPipesMutant.xml");
