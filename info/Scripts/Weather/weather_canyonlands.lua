...
--------------------------------------------------------------------------------------------
    {
      ...
      modifiers = { -- values added to current baseline (faded in and out)
        ...
        light=          {-0.2,    -0.1,               },
        temperature=    {2,       2,                  },
        gas_radiation=  {0.016,      0.01,            },
        rain_radiation= {0.005,      0.0,              },
        ray_radiation= {0.001,       0.002,           },
...
--------------------------------------------------------------------------------------------
    {
      ...
      modifiers = { -- values added to current baseline (faded in and out)
        ...
        temperature=    {10,      5,                  },
        physical=       {0.1,       0.025,              },
        gas_radiation=  {0.28,       0.075,              },
        rain_radiation= {0.095,       0.0,              },
        ray_radiation= {0.025,       0.01,              },
...
--------------------------------------------------------------------------------------------
    {
      ...
      modifiers = { -- values added to current baseline (faded in and out)
        ...
        gas_radiation=  {0.00375,     0.001,                },
        rain_radiation= {0.0075,      0.005,                },
...
--------------------------------------------------------------------------------------------
    {
      ...
      modifiers = { -- values added to current baseline (faded in and out)
        ...
        gas_radiation=  {0.025,     0.01,              },
        rain_radiation= {0.075,     0.02,              },
        ray_radiation=  {0.005,     0.0025,              },
...
--------------------------------------------------------------------------------------------
    {
      ...
      modifiers = { -- values added to current baseline (faded in and out)
        ...
        gas_radiation=  {0.005,       0.005,                },
        rain_radiation= {0.01,       0.01,                },
        ray_radiation=  {0.01,       0.01,                },
